...
from expenses_tracker_backend.cls.member import Member, MembersList
from expenses_tracker_backend.cls.saveable import Saveable
from expenses_tracker_backend.utils.const import EUROCENT
...
from expenses_tracker_backend.cls.object_with_id import ObjectWithId
...
class List(Saveable):
    ...
    def __init__(self,name:str = '', 
                 ...
                 data_dir: str = prefs.ungrouped_lists_dir, 
    ...
    def load_from_file(path):
        ...
        list_ = List(data['name'], load_from_file= True, load_file_path=path)
