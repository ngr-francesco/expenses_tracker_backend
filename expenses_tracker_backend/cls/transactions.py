...
from expenses_tracker_backend.utils.const import MSG
...
class PendingTransactions(Saveable):
    ...
    def close_all(self):
        p_trans = list(self.pending_transactions.keys())
    ...
    def load(self):
        from expenses_tracker_backend.cls.member import Member
        p_t_file = os.path.join(self.data_dir,self.pending_trans_file_name)
